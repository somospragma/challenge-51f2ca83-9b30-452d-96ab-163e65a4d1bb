...
// === ARCHIVO: src/main/java/com/example/productmanagement/application/ProductService.java
...
// === ARCHIVO: src/main/java/com/example/productmanagement/domain/Product.java
...
// === ARCHIVO: src/main/java/com/example/productmanagement/infrastructure/ProductRepository.java
...
spring:
  data:
    mongodb:
      uri: mongodb://localhost:27017/productmanagement

// === ARCHIVO: src/main/java/com/example/productmanagement/application/ProductController.java
package com.example.productmanagement.application;
...
// === ARCHIVO: src/main/java/com/example/productmanagement/application/ProductDTO.java
package com.example.productmanagement.application;
